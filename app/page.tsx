          ...
          <div className="flex flex-col gap-5 md:gap-6 relative z-10 w-full max-w-sm mx-auto lg:mx-0">
            ...
            <div className="relative">
              ...
              <div className="border-[3px] border-black dark:border-white bg-white dark:bg-black aspect-[4/5] sm:aspect-[3/4] p-2 sm:p-3 shadow-[4px_4px_0_0_#000] md:shadow-[6px_6px_0_0_#000] dark:shadow-[4px_4px_0_0_#fff] dark:md:shadow-[6px_6px_0_0_#fff]">
                <div className="w-full h-full bg-gray-200 dark:bg-zinc-800 border-[3px] border-black dark:border-white overflow-hidden relative flex items-center justify-center group">
                  ...
                  {/* Real image */}
                  <img src="/pfp/makdum-pfp.png" alt="Makdum" className="absolute inset-0 w-full h-full object-cover grayscale transition-all duration-500 group-hover:grayscale-0 group-hover:scale-105" />
                </div>
              </div>
