                    ...
                    <div className="flex flex-col gap-6 w-full">
                        ...
                        <div className="text-center sm:text-left mt-2">
                            ...
                            <div className="flex justify-center sm:justify-start gap-4">
                                <a href="https://github.com/MakdumIbrohim" target="_blank" rel="noopener noreferrer" className="border-[3px] border-black dark:border-white bg-white dark:bg-black p-3 hover:bg-[#f8e71c] dark:hover:bg-[#b8a900] shadow-[2px_2px_0_0_#000] dark:shadow-[2px_2px_0_0_#fff] hover:translate-y-[2px] hover:shadow-none transition-all">
                                ...
                                <a href="https://www.instagram.com/mkdmibrhm_" target="_blank" rel="noopener noreferrer" className="border-[3px] border-black dark:border-white bg-white dark:bg-black p-3 hover:bg-[#ff79c6] dark:hover:bg-[#ff79c6] shadow-[2px_2px_0_0_#000] dark:shadow-[2px_2px_0_0_#fff] hover:translate-y-[2px] hover:shadow-none transition-all group">
                                ...
                                <a href="https://www.linkedin.com/in/makdum-ibrohim/" target="_blank" rel="noopener noreferrer" className="border-[3px] border-black dark:border-white bg-white dark:bg-black p-3 hover:bg-[#4a90e2] dark:hover:bg-[#4a90e2] shadow-[2px_2px_0_0_#000] dark:shadow-[2px_2px_0_0_#fff] hover:translate-y-[2px] hover:shadow-none transition-all group">
